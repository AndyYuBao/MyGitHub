...
public class Tetris extends JPanel {
    ...
    static {
        try {
            I = ImageIO.read(new File("D:\\MyGitHub\\Game\\src\\demo_02\\images\\I.png"));
            J = ImageIO.read(new File("D:\\MyGitHub\\Game\\src\\demo_02\\images\\J.png"));
            L = ImageIO.read(new File("D:\\MyGitHub\\Game\\src\\demo_02\\images\\L.png"));
            O = ImageIO.read(new File("D:\\MyGitHub\\Game\\src\\demo_02\\images\\O.png"));
            S = ImageIO.read(new File("D:\\MyGitHub\\Game\\src\\demo_02\\images\\S.png"));
            T = ImageIO.read(new File("D:\\MyGitHub\\Game\\src\\demo_02\\images\\T.png"));
            Z = ImageIO.read(new File("D:\\MyGitHub\\Game\\src\\demo_02\\images\\Z.png"));
            backImage = ImageIO.read(new File("D:\\MyGitHub\\Game\\src\\demo_02\\images\\background.png"));
        } catch (IOException e) {
        ...
        KeyListener l = new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                switch (code) {
                    ...
                    case KeyEvent.VK_LEFT -> moveLeftAction();
    ...
    public static void main(String[] args) {
        //创建一个窗口对象
        JFrame frame = new JFrame("俄罗斯方块儿");
        //创建游戏界面，也就是面板
